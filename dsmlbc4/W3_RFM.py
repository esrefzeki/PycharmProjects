...
df = df_.copy() # Burada df 'in bir kopyasını alarak verilerde yaşanabilecek veri bozulmalarının önüne geçiyoruz

df.head() # Burada df veri indexlerinin .head() ile ilk 5 satırını alıyoruz
df.isnull().sum()
